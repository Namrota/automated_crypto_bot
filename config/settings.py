...
SPOT_TICKERS=['BTCUSDT','ETHUSDT','SOLUSDT','XRPUSDT','BNBUSDT', 'DOGEUSDT', 'ADAUSDT', 'TRXUSDT', 'ETCUSDT', 'LTCUSDT', 'BCHUSDT', 'ATOMUSDT', 'XLMUSDT', 'XMRUSDT', 'ATOMUSDT', 'PAXGUSDT', 'DOTUSDT']
